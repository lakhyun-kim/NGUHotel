...
<div class="middle-of">
	...
	<form action="event_write.do" enctype="multipart/form-data"  id="event_form" method="post">
		...
		<tr >
			...
			<td>	<input type="text" id="event_subject" name="event_subject" size="48">
		...
		<tr>
			...
			<td>				
				<input type="text" id="event_price1" name="event_price1">
				<label for="price2">~</label>
				<input type="text" id="event_price2" name="event_price2">
			</td>
		</tr>
		<tr>
