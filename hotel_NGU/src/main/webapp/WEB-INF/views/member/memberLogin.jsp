...
<div class="page-main-style">
	...
	<div style="background-color:#f1ebd6; width:60%; margin:0 auto; padding:20px">
		<div class="align-center">
		...
		<div class="align-center">
			...
			<input type="button" class="myButton1" id="findId" value="N.G.U번호 또는 아이디 찾기" onclick="window.open('findId.do', '_blankId', 'width=500, height=145, resizable=no, menubar=no, location=no, left=500, top=500, toolbar=no')">
