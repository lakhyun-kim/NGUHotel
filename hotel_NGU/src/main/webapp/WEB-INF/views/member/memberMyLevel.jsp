...
<div class="page-main-style">
	...
	<div>
		<strong class="color">${member.mem_lastname} ${member.mem_firstname}님</strong>의 N.G.U 등급 및 포인트에 대한 안내입니다.
	</div><br>
	<div style="border:2px solid #865009">
		<ul class="ulPoint">
			<li><strong>N.G.U 회원 등급 : <span class="color">${member.mem_lev_name}</span></strong></li>
			<li style="padding-left:50px"><strong>N.G.U 포인트 : <span class="color">${member.mem_point}</span></strong></li>
		</ul>
	</div><br>
	<div style="border:2px solid #865009">
		<ul class="ulLevel">
			...
			<c:if test="${member.mem_lev_num == 1}">
				...
				<li style="padding-left:100px">
					...
					- 투숙 시 무료 Laundry 서비스<br>(서울신라호텔: 셔츠 1개 다림질, 제주신라호텔 : 셔츠 1개 세탁)<br>
			...
			<c:if test="${member.mem_lev_num == 2}">
				...
				<li style="padding-left:100px">
					...
					- 투숙 시 무료 Laundry 서비스 <br> (서울신라호텔: 정장 1벌, 셔츠 1개 다림질,<br> 제주신라호텔 : 상,하의 각 1개 세탁)<br>
					- 객실 연 5회 업그레이드(1회 限 스위트 객실 업그레이드 제공)<br>
					- Express Check-In/Check-Out<br>
					- Early Check-In,(12시) Late Check-out (15시)<br> (호텔 별 예약 상황에 따라 제공이 제한될 수 있습니다.)<br>
